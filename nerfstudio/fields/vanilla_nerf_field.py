...
class NeRFField(Field):
    ...
    def __init__(
        ...
        if use_appearance_embedding:
            ...
            in_dim = (
                self.mlp_base.get_out_dim() + self.direction_encoding.get_out_dim()
    ...
    def get_outputs(
        ...
        for field_head in self.field_heads:
            ...
            if self.use_appearance_embedding:
                ...
                mlp_out = self.mlp_head(torch.cat([encoded_dir, density_embedding, embedded_appearance], dim=-1))  # type: ignore
            else:
